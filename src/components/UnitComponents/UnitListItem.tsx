...
export default function UnitListItem({ unit }: { unit: UnitInterface }) {
    ...
    return isEditing ? (
        <>
            <form className="flex gap-2 text-2xl my-2 justify-between w-[80%] mx-auto" onSubmit={handleSubmit(HandleSubmitUpdateUnit)}>
        ...
        <div className="flex gap-2 text-white text-2xl my-2 justify-between w-[80%] border-b pb-1 mx-auto">
            <div>{unit.name}</div>
            {unit.id != '1'
